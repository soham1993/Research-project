...
a=1
for i in os.listdir('C:/Users/Soham Dutta/Desktop/Pictures/2-01-2019' ):
    ...
    cv2.imwrite("C:/Users/Soham Dutta/Desktop/Pictures/2-01-2019/"+str(i)+"/output.jpg",Final_output )
